...
if [ ! -d "../Samples" ]; then
    ...
    (cd "../Samples" && exec curl -OL mirrors.ocf.berkeley.edu/blender/demo/splash/blender-4.3-splash.blend)
    
    echo "--4.2 Splash Screen--"
    echo "-Warning - ZIP File-"
    echo "Downloading File"
    (cd "../Samples" && exec curl -OL mirrors.ocf.berkeley.edu/blender/demo/splash/blender-4.2-splash.zip)
    ...
    (cd "../Samples" && exec curl -OL mirrors.ocf.berkeley.edu/blender/demo/splash/blender-4.1-splash.blend)
    echo "4.0 Splash Screen"
    (cd "../Samples" && exec curl -OL mirrors.ocf.berkeley.edu/blender/demo/splash/blender-4.0-splash.blend)

    echo "--3.1 Splash Screen--"
    echo "-Warning - ZIP File-"
    echo "Downloading File"
    (cd "../Samples" && exec curl -OL mirrors.ocf.berkeley.edu/blender/demo/splash/blender-3.1-splash.zip)
    echo "Moving file to its directory"
